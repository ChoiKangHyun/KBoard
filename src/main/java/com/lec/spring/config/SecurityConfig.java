...
//    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf(csrf -> csrf.disable())  // CSRF 비활성화
                 ...
                 ********************************************/
                .formLogin(form -> form.loginPage("/user/login")   // 로그인 필요한 상황(인증 필요상황) 발생 시, 매개변수 url (로그인 폼) 으로 request 발생
                 ...
                 ********************************************/
                .logout(httpSecurityLogoutConfigurer -> httpSecurityLogoutConfigurer.logoutUrl("/user/logout")
//                              .logoutSuccessUrl("/user/login?logout")
                ...
                .oauth2Login(httpSecurityOAuth2LoginConfigurer -> httpSecurityOAuth2LoginConfigurer
                        ...
                        // code 를 받아오는 것이 아니라, AccessToken과 사용자 profile 정보를 받아오게 된다
